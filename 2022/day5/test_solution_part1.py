...
from solution_part1 import run_day5_part1, parse_text_input, CargoShip, CrateMove
...
def test_parse_text_input():
    ...
    assert cargo_ship.crate_stacks[0] == ['N', 'Z']
    assert cargo_ship.crate_stacks[1] == ['D', 'C', 'M']
    assert cargo_ship.crate_stacks[2] == ['P']
...
def test_run_with_sample_input():
    ...
    assert run_day5_part1(str(cur_dir / 'sample_input.txt')) == 'CMZ'
